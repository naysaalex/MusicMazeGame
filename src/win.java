...
public class win extends JPanel implements KeyListener{
    int x=5;
    int y=5;
...
//            question5.loop();
//            Thread.sleep(3000);
            AudioInputStream ao= AudioSystem.getAudioInputStream(new File("C:\\Users\\naysa\\Desktop\\oth School\\highschool\\compsci 2\\IdeaProjects\\FlyingCoconut\\FlyingCoconut\\Music\\EIA.wav").getAbsoluteFile());
    ...
    public void paint(Graphics g)
    {
        ...
        g.drawString("press the 'ESC' key if you want to leave",70,250);
        g.drawString("OR",235,300);
        g.drawString("press the 'R' key to get another W",100,350);}
    @Override
